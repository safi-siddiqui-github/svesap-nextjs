...
import { recoverCategoryAction } from '@/actions/categoryActions';
...
type RecoverCategoryTableComponentType = {
  data?: CategoryType[];
};

export default function RecoverCategoryTableComponent(
  props: RecoverCategoryTableComponentType
) {
  const { data } = props;
